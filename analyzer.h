...
void selectVariables(itreestream& stream)
{
  ...
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v1", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v1);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v2", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v2);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v3", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v3);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v4", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v4);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v5", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v5);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v6", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v6);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v7", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v7);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v8", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v8);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v9", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v9);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v10", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v10);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v11", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v11);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v12", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v12);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v13", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v13);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v14", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v14);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v15", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v15);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v16", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v16);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v17", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v17);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v18", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v18);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v19", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v19);
  stream.select("edmTriggerResultsHelper_TriggerResults_HLT.presclae_HLT_MET120_HBHENoiseCleaned_v20", edmTriggerResultsHelper_prescale_HLT_MET120_HBHENoiseCleaned_v20);
